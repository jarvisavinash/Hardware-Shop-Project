...
// localStorage.setItem('paymentDetails', JSON.stringify(userData));

// const xyz = JSON.parse(localStorage.getItem("customerDetails"));
...
// axios
//     .post('http://localhost:8045/app/order/save', Order)
//     .then(res => {
//         console.log(res);
